{{-- <div>
    ...
    <p>{{ $config['sakuraData']->reviewer_member->name1.' '.$config['sakuraData']->reviewer_member->name2 }} 様（構成員番号{{ $config['sakuraData']->reviewer_member->login_id }}）が振り返りシートを共有しました。</p>
...
<div>
    <p>振返り担当者（{{ $config['sakuraData']->reviewer_member->name1.' '.$config['sakuraData']->reviewer_member->name2 }}※）が振返りシートを修正しました</p>
