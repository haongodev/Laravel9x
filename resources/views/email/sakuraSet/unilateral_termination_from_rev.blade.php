...
<div>
    ...
    <p>{{ $config['sakuraData']->reviewer_member->name1.' '.$config['sakuraData']->reviewer_member->name2 }} 様（構成員番号{{ $config['sakuraData']->reviewer_member->login_id }}）から、さくらセットの振り返り担当者申請が取り消されました。</p>
