                        ...
                        if (response.success) {
                            ...
                            if(share_flg == 1){
                                $('.a015-initive-list').children('div').each(function(){
                                    $(this).find('.sharing').attr('data-current-share',0).removeClass('sharing').addClass('none-share');
                                ...
                                $('.initiativetable-id-'+id).find('.share-initiativetable').removeClass('sharing');
