<div class="popup-wrapper hidden popup-A015-choose_date">
    <div class="layout-popup">
        ...
        <div class="popup-footer">
            <button type="button" class="btn-popup-accept initiative-accept btn-eff-ora">はい</button>
            <button type="button" class="btn-popup-decline close-A015-choose_date btn-eff-ora">いいえ</button>
        </div>
    </div>
</div>
@push('styles')
