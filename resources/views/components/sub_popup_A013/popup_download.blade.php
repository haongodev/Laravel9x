    ...
    <div class="layout-popup">
        ...
        <div class="popup-content">
            <div class="header-content not-remove">
                ...
                <button class="title-popup button-link btn-eff-ora"><a download href="/templates/facesheet/facesheet.xlsx">Excel</a></button>
                <button class="title-popup button-link btn-eff-ora"><a download href="/templates/facesheet/facesheet.pdf">PDF</a></button>
            </div>
        </div>
        <div class="popup-footer">
            <button class="button-close close-A013-download btn-eff-bla">戻る</button>
        </div>
    </div>
</div>
@push('js')
