    ...
    <div class="layout-popup">
        ...
        <div class="popup-content">
            <div class="header-content not-remove">
                ...
                <button class="title-popup open-A014-download btn-eff-ora btn-hov">ダウンロードする</button>
            </div>
        </div>
        <div class="popup-footer">
            <button class="button-close close-A014-create btn-eff-bla btn-hov">戻る</button>
        </div>
    </div>
</div>
