    ...
    <div class="layout-popup">
        ...
        <div class="popup-content">
            <div class="header-content not-remove">
                ...
                <button class="title-popup button-link btn-eff-ora"><a href="https://www.jamhsw.or.jp/ugoki/kensyu/document/sakura_set/02-3.pdf" target="_blank">ワークシート作成要綱を確認する</a></button>
                <button class="title-popup open-A014-download btn-eff-ora">ダウンロードする</button>
            </div>
        </div>
        <div class="popup-footer">
            <button class="button-close close-A014-create btn-eff-bla">戻る</button>
        </div>
    </div>
</div>
