        ...
        <div class="w-100 group-control">
            ...
            <div class="w-75 date-group">
                <div class="date-container">
                    <input class="creditInput date-register datepicker" type="text" readonly name="question[{{$questionSetting->id}}][start]"
                           value="{{!empty($arrAnswer[0]) ? date('Y-m-d',strtotime($arrAnswer[0])) : ''}}" />
                    <i class="date-icon fa fa-calendar" aria-hidden="true"></i>
                </div>
                <span>~</span>
                <div class="date-container">
                    <input class="creditInput date-register datepicker" type="text" readonly name="question[{{$questionSetting->id}}][end]"
