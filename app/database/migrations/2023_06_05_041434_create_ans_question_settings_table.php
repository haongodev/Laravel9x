...
class CreateAnsQuestionSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('ans_question_settings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ans_question_settings');
    }
}
