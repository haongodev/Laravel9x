...
class CreateReflectionsheetManageTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('reflectionsheet_manage', function (Blueprint $table) {
            $table->integer('id')->primary()->comment("ID");
            $table->integer('class')->comment("区分");
    ...
    {
        Schema::dropIfExists('reflectionsheet_manage');
    }
}
