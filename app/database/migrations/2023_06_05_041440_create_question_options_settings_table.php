...
class CreateQuestionOptionsSettingsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('question_options_settings', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('question_options_settings');
    }
}
