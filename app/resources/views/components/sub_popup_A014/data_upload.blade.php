<tr class="reflectionsheet-id-{{$reflectionSheetManager->id}}">
    ...
    <td>
        ...
        <div class="manager btn-eff-ora btn-hov"><a download class="download" href="{{ asset('storage/upload/'.auth()->user()->user_add_info->login_id.'/reflectionsheet/'.$pathClass.'/'.$reflectionSheetManager->file_name) }}">{{$reflectionSheetManager->display_name}}</a></div>
    </td>
    <td style="width: 100px">
